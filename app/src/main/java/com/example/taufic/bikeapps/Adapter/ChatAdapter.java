...
public class ChatAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = layoutInflater.inflate(R.layout.listchat, null);
            holder = createViewHolder(view);
            view.setTag(holder);
        } else {
            holder = (ViewHolder) view.getTag();
        }
        ChatMessage i = items.get(position);
        if (i != null) {
            boolean myMsg = i.getIsme();
            setAlignment(holder, myMsg);
            holder.txtMessage.setText(i.getMessage());
            holder.txtInfo.setText(i.getDate());
        }
        return view;
    }
